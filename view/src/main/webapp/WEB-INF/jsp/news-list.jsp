          ...
          <%--@elvariable id="newsList" type="java.util.List<News>"--%>
            <c:forEach items="${newsList}" var="news">
             <article class="expanded">
                 ...
                 <div class="leftstr">
                     <a href="${viewUrl}" class="button"><fmt:message key="application.news-list.view" /></a>
                 </div>
                 <div class="rightstr">
                     <a href="${editUrl}" class="button"><fmt:message key="application.news-list.edit" /></a>
                     <a href="${deleteUrl}" class="button button-reversed"><fmt:message key="application.news-list.delete" /></a>
                 </div>
